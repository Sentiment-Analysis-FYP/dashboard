...
export default function Home() {
      ...
      <div className="mt-24 grid grid-cols-2">
        ...
        <div className="ml-5 mr-5 mb-10 pr-2 pl-5 pt-3 pb-3">
          <div>
            ...
            <button className="bg-violet-600 ml-64 mt-8 text-2xl font-extrabold text-white rounded-md h-16 w-52 hover:bg-indigo-300">
            Get Started
            </button>
          </div>
        </div>
  ...
  return (
    <main>
      ...
      <HomePage />
      {/* <div className="bg-white border-gray-300 z-50 w-full h-16 mt-[91px] shadow-lg ">
        <FooterBar />
      </div> */}
    </main>
  );
