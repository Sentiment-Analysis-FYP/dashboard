...
const Header = () => {
  ...
  const fadeInTopRight =
    "opacity-100 duration-150 scale-100 ease-in-out delay-75";
  const fadeOutTopRight =
    "opacity-0 invisible duration-100 scale-50 translate-x-40 -translate-y-32";
  ...
  const UserProfile = () => {
    return (
      <Link href="/login">
        <div
          className="rounded-full w-10 h-10 text-white bg-violet-500 uppercase
  ...
  return (
    <div className="fixed top-0 left-0 bg-white z-40 h-22 w-full ">
      <div className=" w-full flex items-center">
        <div className="px-6 w-full">
          <div className=" w-full border-gray-300 py-6 items-center px-10 flex">
            <div className="float-left">
              <Link href="/">
                <span className=" font-bold text-4xl text-violet-800 tracking-[15px]">
                  SENTINEL
                </span>
              </Link>
            </div>
        ...
        {userEmail ? (
          <div className="flex justify-center items-center mr-14 mt-2">
            <UserProfile />
            <span
          ...
          <div className="text-lg w-72 right-20 text-violet-600 flex justify-center items-center gap-5 ">
            <Link href="/login">
              <span className="bg-violet-50 px-3 py-1 rounded-lg hover:bg-violet-100">
                Login
              </span>
            </Link>
            <Link href="/register">
      ...
      <div
        className={
          mobileMenu
            ? "opacity-100 flex visible flex-col items-center fixed top-0 left-0 w-full p-4" +
              " bg-transparent overflow-hidden z-50 " +
              fadeInTopRight
      ...
      >
        <div
          className="fixed top-6 right-10 rounded-full w-16 h-16
